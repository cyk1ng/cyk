	...
	<table border="0" cellpadding="1" cellspacing="2" style="width:99%;table-layout:fixed;border-color: #E7ECF1;">
	    <tr style="padding-top: 2px;height: 60px;">
	    	<td colspan="2" style="width: 100%;">
				<a class="mini-button mini-button-primary" onclick="submitTask('1')">受理</a>
				<a class="mini-button mini-button-primary" onclick="submitTask('2')">不予受理</a>
				<a class="mini-button mini-button-primary" onclick="submitTask('3')">当场办结</a>
