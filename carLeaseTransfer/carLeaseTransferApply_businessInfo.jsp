...
<!-- 				textField="text" valueField="id" onvaluechanged="quotaInfoChange()" value="1" -->
<!-- 				data="[{id:'1',text:''}]" -->
<!-- 				> -->
<!-- 			</div> -->
<!-- 		</div> -->
...
<!--    	</div> -->
   	...
   	<div id="carDiv">
	   	<div style="float: left;vertical-align: baseline;">
	   		<h3 class="font-16" style="display: inline-block;">车辆过户</h3>
	   	</div>
<!-- 	   	<div style="float: right;margin-top:25px"> -->
...
<!-- 		</div> -->
		...
		<form id="form_car">
			...
			<div style="width: 48%;height: 100%;float: left;">
				<div id="datagrid01" class="mini-datagrid" style="width:100%;height:500px;" allowResize="false" url="${webProperties['app.url.approval']}/carLeaseTransfer/queryVehicleBasicTaxiList.htm"
			...
			<div style="width: 48%;height: 100%;float: right;">
				<div id="datagrid02" class="mini-datagrid" style="width:100%;height:500px;" allowResize="false" url="" idField="id" multiSelect="true" allowUnselect="true"
				    showPager="false">
					<div property="columns">
