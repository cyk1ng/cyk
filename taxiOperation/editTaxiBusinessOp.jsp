...
<script type="text/javascript">
	...
	function initGridData() {
		...
		// 编辑更新
			...
			$.ajax({
				type : "POST", 
				url : "${webProperties['app.url.approval']}/taxiBusinessOp/getTaxiBusinessOpEditData.htm",
				data : {  
...
// 	                mini.alert("办结成功");
    ...
    function setSomeReadOnly(){
	 ...
	 function deleteTaxiInfo() {
		...
		setTaxiLeftCarQuotaRight(vehicles);
	 }
 	// 验证是否有相同的车牌
