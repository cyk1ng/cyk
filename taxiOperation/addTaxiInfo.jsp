...
<!-- 				             style="width:14%;" /> -->
				            <input name="licensePlate4" id="licensePlate4" class="mini-textbox" required="true" style="width:42%;" onblur="myChange('licensePlate4');" vtype="rangeChar:6,7" onvalidation="engChange('licensePlate4',e);" /><span style="color: red;">*</span>
				        ...
				        <td style="width:50%">
				            <input name="batchInsertion" id="batchInsertion" class="mini-textbox"  onvalidation="Insertion('licensePlate4','batchInsertion',e)" style="width:96%;" vtype="int;range:0,1000"/>
				        </td>
				    </tr>
				    <tr>
				     	<td style="width:130px;" align="right">车辆型号：</td>
				        <td style="width:50%">
<!-- 				            <input name="brandModel" id="brandModel" class="mini-textbox" style="width:82%;" vtype="rangeChar:1,150"/> -->
				    ...
				    <tr>
				        ...
				        <td style="width:50%">
				            <input name="carType" id="carType" class="mini-combobox asLabel" value="3" readOnly="true"
				             textField="typeNm" valueField="typeCd" emptyText="请选择..."  allowInput="false" showNullItem="false"
				    ...
				    <tr>
				        ...
				        <td style="width:50%">
				            <input name="enginePower" id="enginePower" class="mini-textbox" style="width:91%;" vtype="float;range:0,100000.0" /><span>KW</span>
				        </td>
				    ...
				    <tr>
				        ...
				        <td style="width:50%">
				            <input name="enterpriseName" id="enterpriseName" class="mini-textbox asLabel"  style="width:96%;" readOnly="true" vtype="rangeChar:1,150"/>
				        </td>
				        <td style="width:130px;" align="right">企业编号：</td>
				        <td style="width:50%">
				            <input name="enterpriseNumber" id="enterpriseNumber" class="mini-textbox asLabel"  style="width:96%;"  readOnly="true" vtype="rangeChar:1,150"/>
				        </td>
				    </tr>
				    <tr>
				    ...
				    <tr>
				        ...
				        <td style="width:50%">
				            <input name="vehicleBrand" id="vehicleBrand" class="mini-textbox" style="width:96%;"  vtype="rangeChar:1,150"/>
				        </td>
				    </tr>
				    <tr>
				    ...
				    <tr>
				     <td style="width:100%" colspan="6" align="center">
					    ...
					    <a class="mini-button" iconCls="" onclick="doSave()">保存新增</a>
				     </td>
				    </tr>
				</table>
		       </form>
...
<script type="text/javascript">
	...
	// 保存新增
	function doSave() {  
		//Insertion('licensePlate4','batchInsertion',e);
		...
		var data = getDate();
// 		if ( parent.checkGridData(data) == false) {
		if ( window.Owner.checkGridData(data) == false) {
				mini.alert("该车牌号已经存在，请确认！");
				return;
			}
//	 		parent.setGridData(data);
	    window.Owner.setGridData(data);
	    window.Owner.addPlateNm();
	    mini.alert("保存成功！");
	}
