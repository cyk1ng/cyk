...
<head>
    <title>巡游出租汽车客运服务企业名称、法定代表人变更</title>
...
<div class="mini-fit">
                    ...
                    <tr>
                        ...
                        <td style="width:100%" colspan="3">
                            <div id="projectnameSix" name="projectnameSix" class="mini-checkboxlist" repeatItems="3" repeatLayout="table"
                                 textField="text" valueField="id" value="089103001001,089103001003"
        ...
        <div title="业务信息">
            ...
            <form id="form1">
                <table id="gridTable" class="gridTable">
                    ...
                    <tr id="089103001001" name="089103001001">
                        <td>
                    ...
                    <tr id="089103001003" name="089103001003">
                        <td>
    ...
    <div id="tabsButtons">
        <a id="toggleBtn1" class="mini-button" iconCls="" onclick="acceptTaxiCompanyNameAlteration()">当场办结</a>
        <a id="toggleBtn2" class="mini-button" iconCls="" onclick="noacceptTaxiCompanyNameAlteration()">不予受理</a>
        <a id="toggleBtn3" class="mini-button" iconCls="" onclick="saveTaxiCompanyNameAlteration()">保存</a>
...
<script type="text/javascript">
    ...
    var businessItemType = [
        {"id": "089103001001", "text": "企业名称变更"},
        {"id": "089103001003", "text": "法定代表人变更"}
    ]
     ...
     * 保存巡游出租车
     */
    function saveTaxiCompanyNameAlteration() {
        //补件
        if (type == "2" && model == "view") {
            ...
            $.ajax({
                url: "${webProperties['app.url.approval']}/taxiAlteration/saveTaxiCompanyNameAlteration.htm",
                type: 'post',
                contentType: "application/x-www-form-urlencoded; charset=utf-8",
     ...
     * 当场办结巡游出租车
     */
    function acceptTaxiCompanyNameAlteration() {
        mini.confirm("确定当场办结？", "确定？",
            function (action) {
                if (action == "ok") {
                    ...
                    loading(true);
                    $.ajax({
                        url: "${webProperties['app.url.approval']}/taxiAlteration/acceptTaxiCompanyNameAlteration.htm",
                        type: 'post',
                        contentType: "application/x-www-form-urlencoded; charset=utf-8",
                        data: {data: mini.encode(businessObj)},
                        success: function (data) {
     ...
     * 不予受理
     */
    function noacceptTaxiCompanyNameAlteration() {
        mini.confirm("确定不予受理？", "确定？",
            function (action) {
                if (action == "ok") {
                    ...
                    loading(true);
                    $.ajax({
                        url: "${webProperties['app.url.approval']}/taxiAlteration/noacceptTaxiCompanyNameAlteration.htm",
                        type: 'post',
                        contentType: "application/x-www-form-urlencoded; charset=utf-8",
                        data: {data: mini.encode(businessObj)},
                        success: function (data) {
    ...
    function queryTaxiBusinessLicense(businessSearchObj) {
        $.ajax({
            url: "${webProperties['app.url.approval']}/taxiAlteration/queryTaxiCompanyNameAlteration.htm",
            type: 'post',
            contentType: "application/x-www-form-urlencoded; charset=utf-8",
        ...
        mini.confirm("确定重置记录？", "确定？",
            function (action) {
                if (action == "ok") {
                    ...
                    mini.get("projectnameSix").setValue("089103001001,089103001003");
