                ...
                <form id="businessForm">
                    ...
                    <div style="width: 48%;height: 100%;float: left;">
                        <div id="datagridCar" class="mini-datagrid" idField="id"
                             url="${webProperties['app.url.approval']}/taxi/queryTaxiLicenceChangeCarList.htm"
...
//         }
     ...
     */
    function submitSL() {
        var url = "${webProperties['app.url.approval']}/taxi/taxiLicenceChangeSL.htm";
     ...
     */
    function submitNoSL() {
        var url = "${webProperties['app.url.approval']}/taxi/taxiLicenceChangeNoSL.htm";
    ...
    function submitSave() {
        if (type == "2" && model == "view") {
            ...
            var url = "${webProperties['app.url.approval']}/taxi/taxiLicenceChangeSave.htm";
    ...
    function createVehicleOperCert(acceptNumber,type) {
        ...
        $.ajax({
            ...
            async: false, //  默认为true  异步请求 false 同步
            success: function (data) {
                loading(false)
                mini.alert("当场办结成功");
            },
    ...
    function queryTaxiBusinessLicense(businessSearchObj) {
        loading(true);
        $.ajax({
            url: "${webProperties['app.url.approval']}/taxi/queryTaxiChangeInfo.htm",
            type: 'post',
            contentType: "application/x-www-form-urlencoded; charset=utf-8",
