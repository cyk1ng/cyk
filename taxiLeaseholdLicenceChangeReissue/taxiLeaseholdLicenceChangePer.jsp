            ...
            <form id="applicationForm" method="post">
                <table border="0" cellpadding="1" cellspacing="2"
                    ...
                    <tr>
                        ...
                        <td style="width:100%" colspan="3">
                            <div id="projectnameSix" name="projectnameSix" class="mini-radiobuttonlist" textField="text"
                                 valueField="id"
                                 value="089204005001" onvaluechanged="changedProjectValue();">
                            </div>
                ...
                <form id="businessForm">
                    ...
                    <div style="width: 48%;height: 100%;float: left;">
                        <div id="datagridCar" class="mini-datagrid" idField="id"
                             url="${webProperties['app.url.approval']}/taxi/queryLeaseChangeCarList.htm"
...
<script type="text/javascript">
    ...
    var businessItemType = [
        {"id": "089204005001", "text": "换正证"},
        {"id": "089204005002", "text": "换副证"}
    ];
    ...
    $(document).ready(function () {
        ...
        if ("" != acceptNumber && null != acceptNumber) {
            ...
            $("#fileupload").load(function () {
                $("#fileupload")[0].contentWindow.getList("089204005001");
            })
        }
        getApprovalType({});
     ...
     */
    function submitSL() {
        var url = "${webProperties['app.url.approval']}/taxi/taxiLeaseholdLicenceChangeSL.htm";
     ...
     */
    function submitNoSL() {
        var url = "${webProperties['app.url.approval']}/taxi/taxiLeaseholdLicenceChangeNoSL.htm";
    ...
    function submitSave() {
        ...
        if (type == "2" && model == "view") {
            ...
            var url = "${webProperties['app.url.approval']}/taxi/taxiLeaseholdLicenceChangeSave.htm";
    ...
    function queryTaxiBusinessLicense(businessSearchObj) {
        loading(true);
        $.ajax({
            url: "${webProperties['app.url.approval']}/taxi/queryLeaseChangeInfo.htm",
            type: 'post',
            contentType: "application/x-www-form-urlencoded; charset=utf-8",
    ...
    function setTaxiBusinessData(obj) {
        ...
        for (var i = 0; i < pgxxArr.length; i++) {
            //换正证
            if (pgxxArr[i] == "089204005001") {
                businessMatters.push("换正证")
            }
            //换副证
            if (pgxxArr[i] == "089204005002") {
                businessMatters.push("换副证")
            }
        }
