...
<!-- 								<input id="result"  class="mini-textbox asLabel" style="width:96%;" readOnly="true" value=""/> -->
					    ...
					    <tr>
					       	...
					       	<td style="width:100%" colspan="3"> 
							<div class="mini-radiobuttonlist" id="projectnameSix" name="projectnameSix" readOnly="true" repeatItems="1" repeatLayout="table" repeatDirection="vertical" textField="text" valueField="id" data="[{id:'089105001',text:'换证'},{id:'089105002',text:'补证'}]" value="${taxiBussinessEntity.projectnameSix}"></div>
							</td>
				       	</tr>
					    <tr>
							<td>
