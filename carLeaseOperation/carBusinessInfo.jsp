...
<!--BEGIN 业务信息-->
<div  id="banzheng">
<div id="panel1" class="mini-panel" title="额度信息" iconCls="icon-add" style="width:100%;height:180px;" 
...
>
    ...
    <tr>
       <td style="width:130px;" align="right">总额度(普通)：</td>
       <td style="width:25%">
           <input id="totalMaxCarQuota"  class="mini-textbox asLabel" readOnly="true" style="width:40%;" value="0"/>
       	<input id="spare1" style="display:none" class="mini-textbox asLabel" value="0"/>
       	<input id="totalMaxCarQuota_right" style="display:none" class="mini-textbox asLabel" value=""/>
       </td>
       <td style="width:130px;" align="right">剩余额度(普通)：</td>
       <td style="width:25%">
           <input id="leftMaxCarQuota" class="mini-textbox asLabel" readOnly="true" style="width:40%;" value="0"/>
       	<input id="spare2" style="display:none" class="mini-textbox asLabel" value="0"/>
       	<input id="leftMaxCarQuota_right" style="display:none" class="mini-textbox asLabel" value=""/>
       </td>
   	</tr>
   	<tr>
       <td style="width:130px;" align="right">总额度(新能源)：</td>
       <td style="width:25%">
           <input id="totalMidCarQuota"  class="mini-textbox asLabel" readOnly="true" style="width:40%;" value="0"/>
       	<input id="spare3" style="display:none" class="mini-textbox asLabel" value="0"/>
       	<input id="totalMidCarQuota_right" style="display:none" class="mini-textbox asLabel" value=""/>
       </td>
       <td style="width:130px;" align="right">剩余额度(新能源)：</td>
       <td style="width:25%">
           <input id="leftMidCarQuota" class="mini-textbox asLabel" readOnly="true" style="width:40%;" value="0"/>
       	<input id="spare4" style="display:none" class="mini-textbox asLabel" value="0"/>
       	<input id="leftMidCarQuota_right" style="display:none" class="mini-textbox asLabel" value=""/>
       </td>
   	</tr>
   	<tr>
       <td style="width:130px;" align="right">总额度(房车)：</td>
       <td style="width:25%">
           <input id="totalMinCarQuota"  class="mini-textbox asLabel" readOnly="true" style="width:40%;" value="0"/>
       	<input id="spare5" style="display:none" class="mini-textbox asLabel" value="0"/>
       	<input id="totalMinCarQuota_right" style="display:none" class="mini-textbox asLabel" value=""/>
       </td>
       <td style="width:130px;" align="right">剩余额度(房车)：</td>
       <td style="width:25%">
           <input id="leftMinCarQuota" class="mini-textbox asLabel" readOnly="true" style="width:40%;" value="0"/>
       	<input id="spare6" style="display:none" class="mini-textbox asLabel" value="0"/>
       	<input id="leftMinCarQuota_right" style="display:none" class="mini-textbox asLabel" value=""/>
       </td>
   	</tr>
</table>
     </form>
    ...
    <tr>
        ...
        <td style="width:20%">
         ...
         <td style="width:80%">
            ...
            <a id="toggleBtnAdd" class="mini-button" iconCls="" onclick="doAddCar()">新增</a>
            <a id="toggleBtnEdit" class="mini-button" iconCls="" onclick="editCarInfo()">批量更新</a>
        </td>
    </tr>
</table>
<table border="0" cellpadding="1" cellspacing="2" style="width:100%;table-layout:fixed;line-height: 40px;padding-right:40px;">
