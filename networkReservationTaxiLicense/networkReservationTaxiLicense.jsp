    ...
    <div id="tabs1" class="mini-tabs" activeIndex="0" style="width:100%;height:100%;" plain="false"
                    ...
                    <tr>
                        ...
                        <td style="width:100%" colspan="3">
                            <input name="projectname" id="projectname" class="mini-textbox asLabel" style="width:98%;"
                                   readOnly="true" value="网络预约出租汽车经营许可"/>
                        </td>
                    </tr>
                    <tr>
        ...
        <div title="业务信息" style="display: none">
            <form id="businessForm" method="post">
                <h3 class="font-16">业户信息
                    <%--<a id="choose" class="mini-button" iconCls="" style="background: red;color: white;"
                           onclick="chooseNetworkCar()">选择网约车企业预读信息</a></h3>--%></h3>
                <hr/>
                <table border="0" cellpadding="1" cellspacing="2"
                       style="width:100%;table-layout:fixed;line-height: 40px;padding-right:40px;">
                    <tr>
                ...
                <h3 class="font-16">分支企业信息</h3>
                <hr/>
                <table border="0" cellpadding="1" cellspacing="2"
                       style="width:100%;table-layout:fixed;line-height: 40px;padding-right:40px;">
                    <tr>
                        <td style="width:130px;" align="right">分支企业：</td>
                        <td style="width:50%">
                            <input name="branchUnit" id="branchUnit" class="mini-textbox"
                                   style="width:96%;"/>
                        </td>
                        <td style="width:130px;" align="right">分支企业注册地址：</td>
                        <td style="width:50%">
                            <input name="branchRegisterAddress" id="branchRegisterAddress" style="width:96%;"
                                   class="mini-textbox"/>
                        </td>
                    </tr>
                </table>
...
<script type="text/javascript">
     ...
     * TODO 暂无此接口
     */
    function chooseNetworkCar() {
        var url = "${webProperties['app.url.approval']}/networkReservationTaxiLicense/chooseNetworkCar.htm";
        mini.open({
            url: url,
            title: "选择网约车企业",
            width: 950,
     ...
     */
    function acceptBtn() {
        var url = "${webProperties['app.url.approval']}/networkReservationTaxiLicense/acceptNetworkReservationTaxiLicense.htm";
    ...
    function notAcceptedBtn() {
        var url = "${webProperties['app.url.approval']}/networkReservationTaxiLicense/noAcceptNetworkReservationTaxiLicense.htm";
     ...
     */
    function saveBtn() {
        var url = "${webProperties['app.url.approval']}/networkReservationTaxiLicense/saveNetworkReservationTaxiLicense.htm";
    ...
    function updateBusinessInfo() {
        var url = "${webProperties['app.url.approval']}/networkReservationTaxiLicense/changeNetWorkBusiness.htm";
    ...
    function submitData(url, type, applicationForm, businessForm, hiddenDomainForm) {
        try {
            ...
            if (type == 1) {
                ...
                obj2.conditionValue = window.parent.itemId;
                arr1.push(obj2);
    ...
    function updateBusinessModel() {
        ...
        var names = "companyName,companyEconomyType1,companyRegisterAddress,companyContact,companyTel,businessScope";
    ...
    function queryTaxiBusinessLicense(businessSearchObj) {
        loading(true);
        $.ajax({
            url: "${webProperties['app.url.approval']}/networkReservationTaxiLicense/queryNetworkReservationTaxiLicense.htm",
            type: 'post',
            contentType: "application/x-www-form-urlencoded; charset=utf-8",
