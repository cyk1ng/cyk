...
<div class="mini-fit">
    <div id="tabs1" class="mini-tabs" activeIndex="0" style="width:100%;height:100%;" plain="false" buttons="#tabsButtons" buttonsAlign="right">
        <div title="申请信息">
            <form id="form" method="post">
                ...
                <input id="projectnameSix" name="projectnameSix" class="mini-hidden" value="089202001002"/><%--业务事项--%>
        ...
        <div title="业务信息">
            ...
            <form id="form1">
                <table id="gridTable" class="gridTable">
                    ...
                    <tr id="089202001002" name="089202001002">
                        <td >
    ...
    <div id="tabsButtons">
        <a id="toggleBtn1" class="mini-button" iconCls="" onclick="acceptRentBusinessAddressAlteration()">受理</a>
        <a id="toggleBtn2" class="mini-button" iconCls="" onclick="noacceptRentBusinessAddressAlteration()">不予受理</a>
        <a id="toggleBtn3" class="mini-button" iconCls="" onclick="saveRentBusinessAddressAlteration()">保存</a>
...
<script type="text/javascript">
     ...
     * 保存巡游出租车
     */
    function saveRentBusinessAddressAlteration() {
        ...
        loading(true);
        $.ajax({
            url: "${webProperties['app.url.approval']}/rentAlteration/saveRentBusinessAddressAlteration.htm",
            type: 'post',
            contentType: "application/x-www-form-urlencoded; charset=utf-8",
     ...
     * 受理巡游出租车
     */
    function acceptRentBusinessAddressAlteration() {
        mini.confirm("确定受理？", "确定？",
            function (action) {
                if (action == "ok") {
                    ...
                    loading(true);
                    $.ajax({
                        url: "${webProperties['app.url.approval']}/rentAlteration/acceptRentBusinessAddressAlteration.htm",
                        type: 'post',
                        contentType: "application/x-www-form-urlencoded; charset=utf-8",
                        data: {data: mini.encode(businessObj)},
                        success: function (data) {
     ...
     * 不予受理
     */
    function noacceptRentBusinessAddressAlteration() {
        mini.confirm("确定不予受理？", "确定？",
            function (action) {
                if (action == "ok") {
                    ...
                    $.ajax({
                        url: "${webProperties['app.url.approval']}/rentAlteration/noacceptRentBusinessAddressAlteration.htm",
                        type: 'post',
                        contentType: "application/x-www-form-urlencoded; charset=utf-8",
                        data: {data: mini.encode(businessObj)},
                        success: function (data) {
    ...
    function queryRentBusinessLicense(businessSearchObj) {
        $.ajax({
            url: "${webProperties['app.url.approval']}/rentAlteration/queryRentBusinessAddressAlteration.htm",
            type: 'post',
            contentType: "application/x-www-form-urlencoded; charset=utf-8",
        ...
        mini.confirm("确定重置记录？", "确定？",
            function (action) {
                if (action == "ok") {
                    ...
                    mini.get("projectnameSix").setValue("089202001002");
    ...
    function updateBusinessInfo(){
        ...
        $.ajax({
            url: "${webProperties['app.url.approval']}/rentAlteration/updateRentBusinessAddressAlteration.htm",
            type: 'post',
            async: false,
            contentType: "application/x-www-form-urlencoded; charset=utf-8",
