...
<div class="mini-fit">
        ...
        <div title="申请信息">
            <form id="form" method="post">
                ...
                <table border="0" cellpadding="1" cellspacing="2" style="width:100%;table-layout:fixed;line-height: 40px;padding-right:40px;">
                    ...
                    <tr>
                        <td style="width:130px;" align="right">法定法定代表人电话：</td>
                        <td style="width:100%" colspan="3">
                    ...
                    <tr>
                        ...
                        <td style="width:100%" colspan="3">
                            <div id="projectnameSix" name="projectnameSix" class="mini-checkboxlist" repeatItems="3" repeatLayout="table"
                                 textField="text" valueField="id" value="08911020101,08911020102"
        ...
        <div title="业务信息">
            ...
            <form id="form1">
                <table id="gridTable" class="gridTable">
                    ...
                    <tr id="08911020101" name="08911020101">
                        <td>
                    ...
                    <tr id="08911020102" name="08911020102">
                        <td>
    ...
    <div id="tabsButtons">
        <a id="toggleBtn1" class="mini-button" iconCls="" onclick="acceptOnlineCompanyNameAlteration()">当场办结</a>
        <a id="toggleBtn2" class="mini-button" iconCls="" onclick="noacceptOnlineCompanyNameAlteration()">不予受理</a>
        <a id="toggleBtn3" class="mini-button" iconCls="" onclick="saveOnlineCompanyNameAlteration()">保存</a>
...
<script type="text/javascript">
    ...
    var businessItemType = [
        {"id": "08911020101", "text": "企业名称变更"},
        {"id": "08911020102", "text": "法定代表人变更"}
    ]
    ...
    $(document).ready(function () {
        ...
        if ("view" == model) {
            ...
            window.parent.setHangYe("网约", "2011", "", "2");
        }

        var id = getRequestString("id");
        if (id != "" && id != null) {
            $("#fileupload").load(function () {
                queryOnlineBusinessLicense({id: id});
            })
        } else {
        ...
        if ("" != acceptNumber && null != acceptNumber) {
            queryOnlineBusinessLicense({acceptNumber: acceptNumber});
        } else {
     ...
     * 保存巡游出租车
     */
    function saveOnlineCompanyNameAlteration() {
        //补件
        if (type == "2" && model == "view") {
            ...
            $.ajax({
                url: "${webProperties['app.url.approval']}/onlineAlteration/saveOnlineCompanyNameAlteration.htm",
                type: 'post',
                contentType: "application/x-www-form-urlencoded; charset=utf-8",
     ...
     * 当场办结巡游出租车
     */
    function acceptOnlineCompanyNameAlteration() {
        mini.confirm("确定当场办结？", "确定？",
            function (action) {
                if (action == "ok") {
                    ...
                    loading(true);
                    $.ajax({
                        url: "${webProperties['app.url.approval']}/onlineAlteration/acceptOnlineCompanyNameAlteration.htm",
                        type: 'post',
                        contentType: "application/x-www-form-urlencoded; charset=utf-8",
                        data: {data: mini.encode(businessObj)},
                        success: function (data) {
     ...
     * 不予受理
     */
    function noacceptOnlineCompanyNameAlteration() {
        mini.confirm("确定不予受理？", "确定？",
            function (action) {
                if (action == "ok") {
                    ...
                    loading(true);
                    $.ajax({
                        url: "${webProperties['app.url.approval']}/onlineAlteration/noacceptOnlineCompanyNameAlteration.htm",
                        type: 'post',
                        contentType: "application/x-www-form-urlencoded; charset=utf-8",
                        data: {data: mini.encode(businessObj)},
                        success: function (data) {
     ...
     * 查询信息
     */
    function queryOnlineBusinessLicense(businessSearchObj) {
        $.ajax({
            url: "${webProperties['app.url.approval']}/onlineAlteration/queryOnlineCompanyNameAlteration.htm",
            type: 'post',
            contentType: "application/x-www-form-urlencoded; charset=utf-8",
    ...
    function setOnlineBusinessData(obj) {
        ...
        mini.confirm("确定重置记录？", "确定？",
            function (action) {
                if (action == "ok") {
                    ...
                    mini.get("projectnameSix").setValue("08911020101,08911020102");
